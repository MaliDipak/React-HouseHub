...
const EditListing = () => {
  ...
  //use effect to fecth listing (house) data edit
  useEffect(() => {
    setLoading(true);
    const fetchListing = async () => {
      ...
      if (docSnap.exists()) {
        ...
        navigate("/");
        toast.error("Somthing weng wrong!");
      }
    };
    fetchListing();
  }, []);
  ...
  const onSubmit = async (e) => {
      ...
      return new Promise((resolve, reject) => {
        ...
        uploadTask.on(
          ...
          (snapshot) => {
            ...
            //     toast("Updating paused.");
            //     break;
            //   case "running":
            //     // console.log("upload is runnning");
            //     toast("Updating running.");
            //     break;
            //   default:
            //     // console.log("...");
    ...
    //save form data to listings collection at firebase db.
